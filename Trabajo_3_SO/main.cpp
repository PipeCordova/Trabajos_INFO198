...
int main(int argc, char *argv[]) {
    ...
    while (true) {
        ...
        if (eleccion >= 8) {
            ...
            if (perfil == " admin") {
                ejecutarOpcion(eleccion, admin, vectorEntrada, archivoTexto, f, t, i, o);
            }
            if (perfil == " userGeneral") {
                ejecutarOpcion(eleccion, userGeneral, vectorEntrada, archivoTexto, f, t, i, o);
            }
            if (perfil == " userRookie") {
                ejecutarOpcion(eleccion, userRokie, vectorEntrada, archivoTexto, f, t, i, o);
            }
        }

...
void ejecutarOpcion(int eleccion, const vector<int>& vectorPerfil, const vector<int>& vectorEntrada, ifstream& archivoTexto, const string& f, const string& t, const string & i, const string & o);
int obtenerEleccion();
